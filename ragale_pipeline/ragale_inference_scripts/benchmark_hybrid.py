#!/usr/bin/env python3
"""
Benchmark: Hybrid (Logit Masking + NFA Rejection Sampling) — Ragale.

Mirrors domino/benchmark_hybrid.py for Kannada Utsaha Ragale.
...
Expected validity: ~100%.

Usage:
    python ragale_inference_scripts/benchmark_hybrid.py --model gemma3-1b-base --seeds 34
    python ragale_inference_scripts/benchmark_hybrid.py --model gemma3-1b-lora --seeds 34
"""
...
from generate_hybrid import generate_poem
